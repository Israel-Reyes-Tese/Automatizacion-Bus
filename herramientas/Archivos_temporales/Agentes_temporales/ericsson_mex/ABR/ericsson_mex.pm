...
sub _1_3_6_1_4_1_193_183_4_2_0_30
{
    my $entrada = shift;
    my $trap_name = shift;
    my $config_ref = shift;
    ...
    my $dat_probable_cause = 0;
    my $dat_event_type = 10;
    my $dat_additional_text = "This notification is sent when the active alarm list has reached a stable situation after a restart or after a system internal audit process. It is an indication to the manager to perform a alarm resynchronization procedure.\nTrapName = eriAlarmAlarmListRebuilt,\n";
    ...
    ###################################################################################
    if (ifexists($entrada->{"1.3.6.1.4.1.193.183.4.1.3.4"})) {
        $dat_additional_text .= "\neriAlarmActiveTableURL = " . $entrada->{"1.3.6.1.4.1.193.183.4.1.3.4"} . ",\n";
    }
    ################################################################################### 
...
sub _1_3_6_1_4_1_193_183_6_2_0_20
{
    ...
    if (ifexists($entrada->{"1.3.6.1.4.1.193.183.6.1.4.2"})) {
        $dat_additional_text .= "\neriAlarmXAlertLastChanged = " . $entrada->{"1.3.6.1.4.1.193.183.6.1.4.2"} . ",\n";
    }
    if (ifexists($entrada->{"1.3.6.1.4.1.193.183.6.1.3.2"})) {
        $dat_additional_text .= "\neriAlarmXActiveLastChanged = " . $entrada->{"1.3.6.1.4.1.193.183.6.1.3.2"} . ",\n";
    }
    if (ifexists($entrada->{"1.3.6.1.4.1.193.183.6.1.2.9"})) {
        $dat_additional_text .= "\neriAlarmXNObjSourceIdentifier = " . $entrada->{"1.3.6.1.4.1.193.183.6.1.2.9"} . ",\n";
    }
...
sub _1_3_6_1_4_1_193_183_6_2_0_30
{
    my $entrada = shift;
    my $trap_name = shift;
    my $config_ref = shift;
    ...
    my $dat_probable_cause = 0;
    my $dat_event_type = 10;
    my $dat_additional_text = "This notification is sent when the active alarm list has reached a stable situation after a restart or after a system internal audit process. It is an indication to the manager to perform a alarm resynchronization procedure.\nTrapName = eriAlarmXAlarmListRebuilt,\n";
